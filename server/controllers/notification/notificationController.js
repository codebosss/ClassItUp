...
export const sendEmail = (req, res, roomId, email) => {
    var options = {
        ...
        body: {
            ...
            "message": {
                "html": `The class has started! Please join the class by clicking on this link: https://class-it-up-brightestcrocodile-dev.apps.sandbox-m2.ll9k.p1.openshiftapps.com/videoCall/${roomId}`,
