                    ...
                    <Grid container justifyContent="center" spacing={6}>
                        ...
                        <Grid item>
                            <Paper className={classes.paper} textalign="center" data-aos="fade-left">
                                <Button className={classes.button} component={Link} to="/interviewAnalysis" fullWidth variant="contained" align="center"><ThemeProvider theme={headlineTheme}><Typography style={{ color: '#f4f4f4', textAlign: 'center', fontWeight: 'bold' }}>Real-Time Class Analysis</Typography></ThemeProvider></Button>
                            </Paper>
                        </Grid>
                    </Grid>
                </Grid>
